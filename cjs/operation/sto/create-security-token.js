...
class CreateSecurityTokenItem extends item_1.STOItem {
    ...
    toHintedObject() {
        return Object.assign(Object.assign({}, super.toHintedObject()), { granularity: this.granularity.v, default_partition: this.defaultPartition.toString(), controllers: this.controllers.sort(utils_1.SortFunc).map(a => a.toString()) });
    }
}
