...
class RegisterPointFact extends fact_1.PointFact {
    constructor(token, sender, contract, currency, symbol, name, initialSupply) {
        super(alias_1.HINT.POINT.REGISTER_POINT.FACT, token, sender, contract, currency);
    ...
    get operationHint() {
        return alias_1.HINT.POINT.REGISTER_POINT.OPERATION;
    }
}
