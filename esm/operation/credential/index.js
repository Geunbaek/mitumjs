...
class Credential extends base_1.ContractGenerator {
    ...
    async getServiceInfo(contractAddr) {
        return await (0, api_1.getAPIData)(() => api_1.contract.credential.getIssuer(this.api, contractAddr));
    }
    async getCredentialInfo(contractAddr, templateID, credentialID) {
        return await (0, api_1.getAPIData)(() => api_1.contract.credential.getCredential(this.api, contractAddr, templateID, credentialID));
    }
    async getTemplate(contractAddr, templateID) {
        return await (0, api_1.getAPIData)(() => api_1.contract.credential.getTemplate(this.api, contractAddr, templateID));
    }
    async getAllCredentials(contractAddr, templateID) {
        return await (0, api_1.getAPIData)(() => api_1.contract.credential.getCredentials(this.api, contractAddr, templateID));
    }
    async claimCredential(contractAddr, holder) {
        return await (0, api_1.getAPIData)(() => api_1.contract.credential.getCredentialByHolder(this.api, contractAddr, holder));
    }
}
