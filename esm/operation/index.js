...
class Operation extends types_1.Generator {
    ...
    async getAllOperations() {
        return await api_1.operation.getOperations(this.api);
    }
    async getOperation(hash) {
        return await api_1.operation.getOperation(this.api, hash);
    }
    ...
    async send(operation, headers) {
        return await api_1.operation.send(this.api, operation, headers);
    }
}
