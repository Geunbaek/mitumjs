...
class ApproveFact extends fact_1.TokenFact {
    constructor(token, sender, contract, currency, approved, amount) {
        super(alias_1.HINT.TOKEN.APPROVE.FACT, token, sender, contract, currency);
    ...
    get operationHint() {
        return alias_1.HINT.TOKEN.APPROVE.OPERATION;
    }
}
