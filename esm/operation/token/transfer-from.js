...
class TransferFromFact extends fact_1.TokenFact {
    constructor(token, sender, contract, currency, receiver, target, amount) {
        super(alias_1.HINT.TOKEN.TRANSFER_FROM.FACT, token, sender, contract, currency);
    ...
    get operationHint() {
        return alias_1.HINT.TOKEN.TRANSFER_FROM.OPERATION;
    }
}
